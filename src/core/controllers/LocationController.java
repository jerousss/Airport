...
public class LocationController {
    ...
    public static void showLocationsTable(JTable table) {
        List<Location> locations = LocationStorage.getInstance().getLocations();

        DefaultTableModel model = new DefaultTableModel(
                new Object[]{"Airport Id", "Airport Name", "City Airport", "Country Airport"}, 0);
